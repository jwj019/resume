...
%---------------------------------------------------------
  \cventrysix
    ...
    {DevOps engineer working on federal contract for maintaining legacy USCIS verification applications E-Verify and SAVE. Responsibilities include build automation via Jenkins, environment maintenance in Amazon Web Services, and managing code deployments.} % Description of position
    {
