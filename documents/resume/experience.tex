...
%---------------------------------------------------------
  \cventrysix
    ...
    {2010 - 2012} % Date(s)
    {Jack of all trades.  Responsible for all things technology including maintenance of VMWare cluster, training of end users, installation of network infrastructure, and more.} % Description of position
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
